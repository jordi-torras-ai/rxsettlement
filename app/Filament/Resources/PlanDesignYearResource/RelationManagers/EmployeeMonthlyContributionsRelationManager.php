...
class EmployeeMonthlyContributionsRelationManager extends RelationManager
{
    protected static string $relationship = 'employeeMonthlyContributions';

    protected static ?string $title = 'Employee Monthly Contributions';
